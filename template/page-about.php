            ...
            <div class="about-top pt-120 pb-120">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-8 col-md-8 col-sm-12 col-12">
                        <div class="about-text__me disable-mb content-animation" data-scroll data-scroll-offset="0, 30%"
                            data-scroll-sticky data-scroll-target=".about-main">
                            <div class="about-title fs-40 fw-400 pb-20">Hello, I'm Manh Dung Nguyen from Hanoi, Vietnam.
                            </div>
                            <div class="about-desc">
                                <p>I began my design career in 2017, gaining extensive knowledge and experience. I've
                                    been fortunate to work with many wonderful clients and brands. Even now, I strive
                                    for continuous improvement to gain more opportunities to work with new partners.</p>
                                <p>My first job was designing presentation slides in PowerPoint. There, I learned layout
                                    presentation skills, became familiar with motion effects, and developed meticulous
                                    attention to detail.</p>
                                <p>Feeling the need to grow professionally after three years, I pursued web design,
                                    which is also my current role. In addition to learning various web design styles and
                                    skills, I also studied basic programming languages like HTML, CSS, and JavaScript to
                                    better collaborate with the Front-end team.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                    <div>
                                        ...
                                        <div id="gtx-trans" style="position: absolute; left: -15px; top: 76.3906px;">
                                            <div class="gtx-trans-icon">&nbsp;</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="about-detail__content--5 about-section__content content-animation">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                    <div>
                                        <p>40+ projects</p>
                                        <div id="gtx-trans" style="position: absolute; left: -88px; top: 38px;">
                                            <div class="gtx-trans-icon">&nbsp;</div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="about-service-wrap section-relative" data-scroll-section>
        <div class="hero-marquee">
            <div class="hero-marquee-inner" aria-hidden="true">
                <span class="font-tnr font-italic fw-400 fs-120">Business website</span>
                <span class="font-tnr font-italic fw-400 fs-120">Ecommerce website</span>
                <span class="font-tnr font-italic fw-400 fs-120">Landingpage</span>
                <span class="font-tnr font-italic fw-400 fs-120">Mobile app</span>
                <span class="font-tnr font-italic fw-400 fs-120">Ui design</span>
                <span class="font-tnr font-italic fw-400 fs-120">Motion graphic</span>
                <span class="font-tnr font-italic fw-400 fs-120">Powerpoint presentation</span>
                <span class="font-tnr font-italic fw-400 fs-120">Company profile</span>
                <span class="font-tnr font-italic fw-400 fs-120">Social media</span>
            </div>
